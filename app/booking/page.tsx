...
export default function BookingPage() {
  ...
  const handleTourChange = (title: string) => {
    ...
    setSelectedTour(
      tours.find((tour) => `${tour.title} ${tour.price}` === title)
    );
  };
            ...
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full flex flex-col px-4 lg:w-1/2 xl:w-6/12 ">
                ...
                <div className="flex flex-col p-2 gap-4">
                  ...
                  <select
                    value={selectedTour ?? "Выберете Тур"}
                  ...
                  >
                    {/* <option selected>Выберете Тур</option> */}
                    {tours.map((tour: any) => (
                      <option>{`${tour.title} ${tour.price}`}</option>
                    ))}
                  </select>
                  {selectedTour && (
                    <TourCard
                ...
                <div className="relative rounded-lg bg-white lg:p-8 shadow-lg sm:p-12">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="mb-6">
                      ...
                      {!!errors.name && (
                        <div
                          className="bg-red text-red-700 font-bold"
                          role="alert"
                        >
