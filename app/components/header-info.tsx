...
export default function HeaderInfo() {
 ...
 const currentDate = new Date();
    ...
    useEffect(() => {
        fetch('https://www.meteosource.com/api/v1/free/point?lat=41.3N&lon=69.2E&sections=current%2Chourly&language=en&units=metric&key=y1f9tymubwge617ftelk5zjkw54dg3chf1ckup94')
        .then(res => res.json())
